fn main() {
    ...
    println!();
    println!("{} is aimed at developing compeent, creative, innovative, entrepreneurial and ethically-minded persons, capable of creating value in the diverse fields of Computer Science. ",w3);
}
